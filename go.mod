...
replace (
	...
	github.com/scroll-tech/go-ethereum => github.com/morphism-labs/go-ethereum v1.10.14-0.20230721052110-935037f1b7d4
	github.com/tendermint/tendermint => github.com/morphism-labs/tendermint v0.0.0-20230718084757-ac125aa99c03
)
